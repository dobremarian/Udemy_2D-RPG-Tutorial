...
public class GameMenu : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.Escape) && !Shop.instance.shopMenu.gameObject.activeInHierarchy && !BattleManager.instance.battleScene.gameObject.activeInHierarchy)
        {
    ...
    public void UpdateMainStats()
    {
        ...
        for (int i = 0; i < playerStats.Length; i++)
        {
            if (playerStats[i].gameObject.activeInHierarchy)
            {
                ...
                expText[i].text = (string)(playerStats[i].currentEXP + "/" + playerStats[i].expToNextLevel[playerStats[i].playerLevel]);
    ...
    public void SelectItem(Item newItem)
    {
        ...
        if (activeItem.isWapon || activeItem.isArmor)
        {
    ...
    public void CloseItemCharaterChoice()
    {
        itemCharChoiceMenu.SetActive(false);
    }
